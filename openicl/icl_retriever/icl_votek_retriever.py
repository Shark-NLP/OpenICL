...
class VotekRetriever(TopkRetriever):
    ...
    Attributes:
        ...
        votek_k (int): `k` value of Voke-k Selective Annotation Algorithm
    """
    def __init__(self, 
    ...
    def vote_k_search(self):
        vote_k_idxs = self.votek_select(embeddings=self.embed_list, select_num=self.ice_num, k=self.votek_k, overlap_threshold=1)
